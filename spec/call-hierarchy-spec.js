...
describe("Outline", () => {
  ...
  beforeEach(async () => {
    ...
    expect(atom.packages.isPackageLoaded("atom-ide-call-hierarchy"))
      .toBeTruthy();
  ...
  it("adds/removes outline view from workspace when toggled", () => {
    expect(workspaceElement.querySelector("atom-ide-call-hierarchy-view"))
      .toBeVisible();

    atom.commands.dispatch(workspaceElement, "call-hierarchy:toggle");

    expect(workspaceElement.querySelector("atom-ide-call-hierarchy-view")).not
      .toExist();
